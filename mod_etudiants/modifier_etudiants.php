...
function afficher_etu_sio($classe, $connexion) { // $classe = 'SIO1' || $classe = 'SIO2'
    $sql = "SELECT ID_ETU, NOM_ETU, PRENOM_ETU, DNAISSANCE_ETU, ETUDIANT.ID_ORIGINE, 
        CLASSE.CODE_CLASSE, CODE_SPECIALITE, REGIME, ETUDIANT.ID_PROMOTION, DOUBLANT1_ETU, DOUBLANT2_ETU 
    FROM ETUDIANT 
